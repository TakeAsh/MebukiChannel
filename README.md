...
- ダイス補助
  - 選択結果強調表示(範囲指定対応, 複数選択可, 強調色指定可, ゾロ目)
  - RGB値可視化
...
### 機能
- めぶきちたちがマウスポインタを追い掛ける<br><img alt="Mebukichi3" src="https://raw.githubusercontent.com/TakeAsh/MebukiChannel/refs/heads/main/Mebukichi/img/Mebukichi3.gif"> <img alt="Warukichi" src="https://raw.githubusercontent.com/TakeAsh/MebukiChannel/refs/heads/main/Mebukichi/img/WarukichiFull.gif">
- レス以外の場所をダブルクリックで設定メニュー表示<br><img alt="Settings" src="https://raw.githubusercontent.com/TakeAsh/MebukiChannel/refs/heads/main/Mebukichi/img/Settings.png">
- 特定のページまたは特定のタグを含むスレでめぶきちたちを呼べる<br>`すべて` にチェックを入れると全ページでめぶきちたちが来る

### インストール
- [本体ソース](https://github.com/TakeAsh/MebukiChannel/blob/main/Mebukichi/Mebukichi.user.js)
  - TamperMonkey用ユーザースクリプト
  - 右の「Raw」ってボタン押すとインストールするかどうか聞かれるのでインストールを選択
  - 本番環境ヨシ！
- [Bookmarklet](https://github.com/TakeAsh/MebukiChannel/blob/main/Mebukichi/Mebukichi.bookmarklet.js)
